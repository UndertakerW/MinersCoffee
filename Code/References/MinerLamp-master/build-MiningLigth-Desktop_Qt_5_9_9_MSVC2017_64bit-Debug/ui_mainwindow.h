...
"}"));
        ...
        sizePolicy.setHeightForWidth(lcdNumberHashRate->sizePolicy().hasHeightForWidth());
        lcdNumberHashRate->setSizePolicy(sizePolicy);
        lcdNumberHashRate->setDigitCount(7);

        gridLayout_7->addWidget(lcdNumberHashRate, 2, 3, 1, 1);

        checkBoxAutoStart = new QCheckBox(centralWidget);
        checkBoxAutoStart->setObjectName(QStringLiteral("checkBoxAutoStart"));

        gridLayout_7->addWidget(checkBoxAutoStart, 2, 0, 1, 1);

        checkBoxOnlyShare = new QCheckBox(centralWidget);
        checkBoxOnlyShare->setObjectName(QStringLiteral("checkBoxOnlyShare"));

        gridLayout_7->addWidget(checkBoxOnlyShare, 8, 0, 1, 2);
        ...
        gridLayout_7->addWidget(groupBox, 6, 0, 1, 4);
        ...
        gridLayout_7->addWidget(groupBoxWatchdog, 3, 0, 1, 4);
        ...
        gridLayout_7->addWidget(groupBoxNvidia, 4, 0, 1, 4);

        textEdit = new QTextEdit(centralWidget);
        textEdit->setObjectName(QStringLiteral("textEdit"));
        textEdit->setReadOnly(true);

        gridLayout_7->addWidget(textEdit, 9, 0, 1, 4);
        ...
        gridLayout_7->addWidget(pushButtonShowHideLog, 8, 2, 1, 1);
        ...
        gridLayout_7->addWidget(groupBoxAMD, 5, 0, 1, 4);
        ...
        gridLayout_7->addWidget(groupBox_2, 7, 0, 1, 4);
        ...
        gridLayout_7->addWidget(groupBoxPools, 10, 0, 1, 4);
