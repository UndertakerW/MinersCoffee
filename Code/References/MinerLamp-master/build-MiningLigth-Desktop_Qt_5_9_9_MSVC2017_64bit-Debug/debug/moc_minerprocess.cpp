...
QT_MOC_LITERAL(8, 78, 16), // "onReadyToMonitor"
QT_MOC_LITERAL(9, 95, 11), // "onNoHashing"
QT_MOC_LITERAL(10, 107, 8), // "onDonate"
QT_MOC_LITERAL(11, 116, 14), // "onBackToNormal"
QT_MOC_LITERAL(12, 131, 16) // "onReadyToRestart"
    ...
    "onBackToNormal\0onReadyToRestart"
};
#undef QT_MOC_LITERAL
...
void MinerProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onReadyToMonitor(); break;
        case 5: _t->onNoHashing(); break;
        case 6: _t->onDonate(); break;
        case 7: _t->onBackToNormal(); break;
        case 8: _t->onReadyToRestart(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
